...
paper:
  ...
  figures:
    ...
    - src: /images/papers/zoaf-circuits.png
      kind: result
      alt: "Schematics of a three-stage op-amp and a two-stage cascaded amplifier"
      caption: "Benchmark schematics: (a) a three-stage op-amp and (b) the 22-parameter two-stage cascaded signal-conditioning amplifier."
    - src: /images/papers/zoaf-convergence.png
      kind: result
      alt: "Best-so-far peaking versus number of simulator calls for ZOAF and six baselines"
      caption: "Best-so-far peaking on the 22-parameter amplifier under a 100-call simulator budget, median over 100 random seeds. ZOAF (blue) separates from CMA-ES, TuRBO-1, DE, PSO, AutoCkt and DNN-Opt early and ends roughly an order of magnitude lower."
  faq:
